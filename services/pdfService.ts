...
// In a real-world scenario, you would need to ensure a font that supports Khmer is available.
// We'll proceed as if a font like 'NotoSansKhmer' is bundled or available to jsPDF.
// The default fonts in jsPDF do not support Khmer script.
// This example adds a placeholder font 'Amiri' which has broad character support in some jsPDF distributions.
import {AmiriRegular} from './Amiri-Regular';
...
export const generateQuizPdf = (
    ...
    // Add font that supports Khmer script
